function [s2, k] = method3_gls(y)
% This function realizes method 3 for gls detrended data in the problem
...
% Inputs:  
%
% y: detrended inflation data (1 country)
% NOTE: y here means GLS detrended data. 
%
% Outputs:
...
% Delta y_t = b_0 * y_t-1 + sum^{k}_{i=1}b_i*Delta y_t-i + e_t
% 
