function [s2,k]=method2_gls(y)
% This function realizes method 2 for GLS detrended data in the problem
...
%
% Inputs:  
% y: inflation gls data (1 country)
%
% outputs:
